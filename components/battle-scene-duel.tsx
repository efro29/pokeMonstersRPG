...
export function BattleSceneDuel() {
  const {
    battle,
    team,
    bag,
...
{/* AREA DO RIVAL */}
<div className=" left-0 w-full flex justify-center z-30 mt-3">
  <div className="w-[92%] bg-black/70 backdrop-blur-md rounded-xl px-4 py-2 flex items-center justify-between border border-white/10">

    {/* 🔴 LADO ESQUERDO - FOTO + NOME */}
    <div className="flex items-center gap-3">
      <img
        src="/images/trainers/rival.png"
        alt="Rival"
    ...
    <div className="flex items-center gap-2">
      ...
      {[1,2,3].map((i) => (
        <div
          key={`inactive-${i}`}
          className="w-5 h-5 rounded-full bg-gray-600 border-2 border-gray-400 opacity-40"
        />
      ))}
...
<div className="relative w-full max-w-[500px] mx-auto">
      ...
      {/* ARENA */}
      <div className="relative w-full h-[270px] overflow-hidden rounded-md">
